  ...
  return {
    ...
    components: {
      ...
      schemas: referenceReusableObjectSchemas({
        ...
        SandboxCapabilities: json(SandboxCapabilitiesSchema),
        ComputerActionRequest: json(ComputerActionRequestSchema),
        ComputerScreenshotRequest: json(ComputerScreenshotRequestSchema),
        ...
        CreateSandboxRecordingRequest: json(CreateSandboxRecordingRequestSchema),
        SandboxRecording: json(SandboxRecordingSchema),
        SandboxRecordingListResponse: json(SandboxRecordingListResponseSchema),
    ...
    paths: {
      ...
      "/v1/sandboxes/{sandbox_id}/capabilities": {
        parameters: [parameterRef("SandboxIdPath"), parameterRef("ProjectScopeHeader")],
        get: {
          ...
          security: [{ bearerAuth: [] }],
          responses: {
            "200": response("Observed sandbox capability manifest", "SandboxCapabilities"),
            "401": errorResponse("Authentication required"),
            "403": errorResponse("Access denied"),
            "404": errorResponse("Sandbox not found"),
            "409": errorResponse("Capabilities are not available"),
          },
        },
      },
      ...
      "/v1/sandboxes/{sandbox_id}/computer/actions": {
        parameters: [parameterRef("SandboxIdPath"), parameterRef("ProjectScopeHeader")],
        post: {
          operationId: "performSandboxComputerAction",
          tags: ["runtime"],
          security: [{ bearerAuth: [] }],
          parameters: [parameterRef("IdempotencyKeyHeader")],
          requestBody: { required: true, content: jsonContent("ComputerActionRequest") },
          responses: {
            "202": response("Computer action accepted", "RuntimeOperation"),
            "400": errorResponse("Idempotency-Key is required"),
            "401": errorResponse("Authentication required"),
            "403": errorResponse("Access denied"),
            "404": errorResponse("Sandbox not found"),
            "409": errorResponse("Sandbox or capability unavailable"),
            "422": errorResponse("Invalid computer action"),
          },
        },
      },
      "/v1/sandboxes/{sandbox_id}/computer/screenshots": {
        parameters: [parameterRef("SandboxIdPath"), parameterRef("ProjectScopeHeader")],
        post: {
          operationId: "captureSandboxScreenshot",
          tags: ["runtime"],
          security: [{ bearerAuth: [] }],
          requestBody: { required: true, content: jsonContent("ComputerScreenshotRequest") },
          responses: {
            "202": response("Screenshot capture accepted", "RuntimeOperation"),
            "401": errorResponse("Authentication required"),
            "403": errorResponse("Access denied"),
            "404": errorResponse("Sandbox not found"),
            "409": errorResponse("Sandbox or capability unavailable"),
            "422": errorResponse("Invalid screenshot request"),
          },
        },
      },
      "/v1/sandboxes/{sandbox_id}/recordings": {
        parameters: [parameterRef("SandboxIdPath"), parameterRef("ProjectScopeHeader")],
        get: {
          operationId: "listSandboxRecordings",
          tags: ["runtime"],
          security: [{ bearerAuth: [] }],
          parameters: [parameterRef("CursorQuery"), parameterRef("LimitQuery")],
          responses: {
            "200": response("Sandbox recording page", "SandboxRecordingListResponse"),
            "401": errorResponse("Authentication required"),
            "403": errorResponse("Access denied"),
            "404": errorResponse("Sandbox not found"),
            "422": errorResponse("Invalid cursor"),
        ...
        post: {
          operationId: "startSandboxRecording",
          tags: ["runtime"],
          security: [{ bearerAuth: [] }],
          parameters: [parameterRef("IdempotencyKeyHeader")],
          requestBody: {
            required: true,
            content: jsonContent("CreateSandboxRecordingRequest"),
          },
          responses: {
            "202": response("Recording start accepted", "SandboxRecording"),
            "400": errorResponse("Idempotency-Key is required"),
            "401": errorResponse("Authentication required"),
            "403": errorResponse("Access denied"),
            "404": errorResponse("Sandbox not found"),
            "409": errorResponse("Sandbox or recording capability unavailable"),
            "422": errorResponse("Invalid recording request"),
          },
        },
      },
      "/v1/sandboxes/{sandbox_id}/recordings/{recording_id}": {
        parameters: [
          parameterRef("SandboxIdPath"),
          parameterRef("ProjectScopeHeader"),
          {
            ...
            in: "path",
            required: true,
            schema: ref("SandboxRecordingId"),
          },
        ],
        get: {
          operationId: "getSandboxRecording",
          tags: ["runtime"],
          security: [{ bearerAuth: [] }],
          responses: {
            "200": response("Sandbox recording", "SandboxRecording"),
            "401": errorResponse("Authentication required"),
            "403": errorResponse("Access denied"),
            "404": errorResponse("Recording not found"),
          },
        },
      },
      "/v1/sandboxes/{sandbox_id}/recordings/{recording_id}/actions/stop": {
        ...
        post: {
          operationId: "stopSandboxRecording",
          tags: ["runtime"],
          security: [{ bearerAuth: [] }],
          parameters: [parameterRef("OptionalIdempotencyKeyHeader")],
          responses: {
            "202": response("Recording stop accepted", "SandboxRecording"),
            "401": errorResponse("Authentication required"),
            "403": errorResponse("Access denied"),
            "404": errorResponse("Recording not found"),
            "409": errorResponse("Recording cannot be stopped"),
          },
        },
      },
